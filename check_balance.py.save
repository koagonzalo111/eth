...
contract_address = Web3.to_checksum_address('0x4e8c73e7f243d12b7a5571200609523a4890beff')
wallet_address = Web3.to_checksum_address('0xa9a6A3626993D487d2Dbda3173cf58cA1a9D9e9f')
...
if w3.is_connected():
    ...
    print("Failed to connect to Infura")import json
from web3 import Web3
...
# Load ABI from a Python variable (you can also use json.load if saved separately)
abi = [
    {
        "inputs": [
            ...
            {"internalType": "uint256", "name": "_maxTotalMintedSupply", "type": "uint256"},
            {"internalType": "uint256", "name": "_originalChainId", "type": "uint256"}
        ],
        "stateMutability": "nonpayable",
        "type": "constructor"
    }
    # You can add more ABI elements here...
]
